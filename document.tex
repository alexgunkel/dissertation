...
\usepackage[greek,english,ngerman]{betababel}
...
%%%% Revisionsbefehle
\usepackage{color}
\newcommand{\Revision}[2][Theis]{\textcolor{red}{#2}\index{Revision!#1}}
...
\includepdf[pages={1}]{TitelblattDefense.pdf}
\frontmatter
\pagestyle{fancy}
\tableofcontents
\newpage
...
% \printshorthands[prenote=Siglen]
